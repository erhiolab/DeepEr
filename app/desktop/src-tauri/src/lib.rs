...
pub fn run() -> tauri::Result<()> {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::llm::openai_chat::llm_openai_chat_generate,
            commands::llm::openai_chat::llm_openai_chat_test_connection,
            commands::llm::openai_chat::llm_openai_chat_list_models,
