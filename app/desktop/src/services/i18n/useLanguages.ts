		...
		components: {
			...
			main: {
				...
				scheduled: {
					...
					subtitle: t("components.main.scheduled.subtitle"),
					newTask: t("components.main.scheduled.newTask"),
					refresh: t("components.main.scheduled.refresh"),
					nextTitle: t("components.main.scheduled.nextTitle"),
					nextTask: t("components.main.scheduled.nextTask"),
					nextTime: t("components.main.scheduled.nextTime"),
					countdown: t("components.main.scheduled.countdown"),
					countdownNow: t("components.main.scheduled.countdownNow"),
					day: t("components.main.scheduled.day"),
					nextEmpty: t("components.main.scheduled.nextEmpty"),
					empty: t("components.main.scheduled.empty"),
					emptyHint: t("components.main.scheduled.emptyHint"),
					unsavedTitle: t("components.main.scheduled.unsavedTitle"),
					unsavedMessage: t("components.main.scheduled.unsavedMessage"),
					permanent: t("components.main.scheduled.permanent"),
					once: t("components.main.scheduled.once"),
					enabled: t("components.main.scheduled.enabled"),
					disabled: t("components.main.scheduled.disabled"),
					edit: t("components.main.scheduled.edit"),
					delete: t("components.main.scheduled.delete"),
					deleteConfirmTitle: t("components.main.scheduled.deleteConfirmTitle"),
					deleteConfirmMessage: (name: string) => t("components.main.scheduled.deleteConfirmMessage", {name}),
					dialogCreate: t("components.main.scheduled.dialogCreate"),
					dialogEdit: t("components.main.scheduled.dialogEdit"),
					name: t("components.main.scheduled.name"),
					namePlaceholder: t("components.main.scheduled.namePlaceholder"),
					content: t("components.main.scheduled.content"),
					contentPlaceholder: t("components.main.scheduled.contentPlaceholder"),
					kind: t("components.main.scheduled.kind"),
					permanentDesc: t("components.main.scheduled.permanentDesc"),
					onceDesc: t("components.main.scheduled.onceDesc"),
					cycle: t("components.main.scheduled.cycle"),
					hourly: t("components.main.scheduled.hourly"),
					daily: t("components.main.scheduled.daily"),
					weekly: t("components.main.scheduled.weekly"),
					minute: t("components.main.scheduled.minute"),
					minuteHint: t("components.main.scheduled.minuteHint"),
					weekdays: t("components.main.scheduled.weekdays"),
					timeList: t("components.main.scheduled.timeList"),
					addTime: t("components.main.scheduled.addTime"),
					onceTime: t("components.main.scheduled.onceTime"),
					nameEmpty: t("components.main.scheduled.nameEmpty"),
					contentEmpty: t("components.main.scheduled.contentEmpty"),
					onceTimeEmpty: t("components.main.scheduled.onceTimeEmpty"),
					weekdayEmpty: t("components.main.scheduled.weekdayEmpty"),
					timeEmpty: t("components.main.scheduled.timeEmpty"),
