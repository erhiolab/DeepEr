		...
		components: {
			...
			main: {
				...
				characterDesign: {
					...
					description: t("components.main.characterDesign.description"),
					descriptionPlaceholder: t("components.main.characterDesign.descriptionPlaceholder"),
					...
					scenario: t("components.main.characterDesign.scenario"),
					scenarioPlaceholder: t("components.main.characterDesign.scenarioPlaceholder"),
					...
					mesExample: t("components.main.characterDesign.mesExample"),
					mesExamplePlaceholder: t("components.main.characterDesign.mesExamplePlaceholder"),
					systemPrompt: t("components.main.characterDesign.systemPrompt"),
					systemPromptPlaceholder: t("components.main.characterDesign.systemPromptPlaceholder"),
					postHistory: t("components.main.characterDesign.postHistory"),
					postHistoryPlaceholder: t("components.main.characterDesign.postHistoryPlaceholder"),
